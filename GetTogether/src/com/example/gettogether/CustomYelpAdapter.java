...
public class CustomYelpAdapter extends BaseAdapter {
	...
	public CustomYelpAdapter(yelpSuggestions main_activity, ArrayList<String> prgmNameList, ArrayList<Bitmap> prgmImages) {
